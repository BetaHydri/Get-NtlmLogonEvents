    ...
    switch ($baseId)
    {
      ...
      '8001'
      {
        [PSCustomObject]@{
          ...
          DomainName        = if ($props.Count -gt 2)
          {
            $props[2].Value 
          }
          else
          ...
          TargetName        = if ($props.Count -gt 0)
          {
            $props[0].Value 
          }
          else
          ...
          ProcessName       = if ($props.Count -gt 4)
          {
            $props[4].Value 
          }
          else
      ...
      '8002'
      {
        [PSCustomObject]@{
          ...
          DomainName        = if ($props.Count -gt 4)
          {
            $props[4].Value 
          }
          else
          ...
          WorkstationName   = $null
          SecureChannelName = $null
          ProcessName       = if ($props.Count -gt 1)
          {
            $props[1].Value 
          }
          else
      ...
      '8003'
      {
        [PSCustomObject]@{
          ...
          DomainName        = if ($props.Count -gt 1)
          {
            $props[1].Value 
          }
          else
          ...
          TargetName        = $null
          WorkstationName   = if ($props.Count -gt 2)
          {
            $props[2].Value 
          }
          else
      ...
      { $_ -in 8004, 8005, 8006 }
      {
        [PSCustomObject]@{
          ...
          TargetName        = $null
          WorkstationName   = if ($props.Count -gt 3)
          {
            $props[3].Value 
          }
          else
          ...
          SecureChannelName = if ($props.Count -gt 0)
          {
            $props[0].Value 
          }
          else
